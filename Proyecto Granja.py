...
class Hortaliza:
    def _init_(self, nombre, precio, puntos_salud, semillas):
        self.nombre = nombre
        self.precio = precio
...
class Manzana(Hortaliza):
    def _init_(self, nombre="Manzana", precio=25, puntos_salud=10, semillas=3):
        super()._init_(nombre, precio, puntos_salud, semillas)


class Pera(Hortaliza):
    def _init_(self, nombre="Pera", precio=30, puntos_salud=15, semillas=3):
        super()._init_(nombre, precio, puntos_salud, semillas)


class Uva(Hortaliza):
    def _init_(self, nombre="Uva", precio=50, puntos_salud=25, semillas=2):
        super()._init_(nombre, precio, puntos_salud, semillas)


class Pimiento(Hortaliza):
    def _init_(self, nombre="Pimiento", precio=15, puntos_salud=5, semillas=5):
        super()._init_(nombre, precio, puntos_salud, semillas)


class Tomate(Hortaliza):
    def _init_(self, nombre="Tomate", precio=10, puntos_salud=5, semillas=4):
        super()._init_(nombre, precio, puntos_salud, semillas)


class Semilla:
    def _init_(self, es_brote=False, es_crecimiento=False, es_madura=False, tiene_agua=False
...
class Semilla_Manzana(Semilla):
    def _init_(self, es_brote=False, es_crecimiento=False, es_madura=False, tiene_agua=False
                 , tiene_fertilizante=False, tiene_plaga=False, dia_semilla=0):
        super()._init_(es_brote, es_crecimiento, es_madura, tiene_agua, tiene_fertilizante, tiene_plaga, dia_semilla)
...
class Terreno:
    def _init_(self, espacio_siembra, nivel, precio):
...
class Inventario:
    def _init_(self, semillas_manzana, semillas_pera, semillas_uva, semillas_pimiento, semillas_tomate,
...
class Suelo:
    def _init_(self, tiene_semilla, _numero, semilla="No tiene semilla", numero_semilla=10, tiene_agua=False,
...
# Borrar
class Calendario:
    def _init_(self, hora_inicial=6, minutos_iniciales=0, dia_inicial=1, estacion_inicial="Primavera"):
